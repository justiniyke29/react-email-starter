    ...
    <Body style={main}>
      <Container style={container}>
        <Img
          ...
          style={image}
        />
        <Heading style={h1}>Forgot Password</Heading>
        <Text style={{ ...text, marginBottom: "14px" }}>
          Dear [User's Name],
        </Text>
        <Text style={{ ...text, color: "#475467" }}>
          We recently received a request to reset your password. If you didn't
          make this request, please disregard this email. To reset your
          password, please enter the following verification code on the app's
          password reset page:
        </Text>
        ...
        <Text style={{ ...text, color: "#344054", fontWeight: "bold" }}>
          Or Click on this button to reset your password
        </Text>
